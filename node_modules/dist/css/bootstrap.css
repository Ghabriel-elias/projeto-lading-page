...
.table-dark {
  --bs-table-color: #fff;
  --bs-table-bg: #131212;
  --bs-table-border-color: #2b2a2a;
  --bs-table-striped-bg: #1f1e1e;
  --bs-table-striped-color: #fff;
  --bs-table-active-bg: #2b2a2a;
  --bs-table-active-color: #fff;
  --bs-table-hover-bg: #252424;
...
.btn-dark {
  ...
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: #424141;
  --bs-btn-active-border-color: #2b2a2a;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #fff;
...
.dropdown-menu {
  ...
  --bs-dropdown-link-color: #131212;
  --bs-dropdown-link-hover-color: #111010;
...
.list-group {
  ...
  --bs-list-group-action-active-color: #131212;
